...
public class Test {
	...
	public static void main(String[] args) {
		...
		b.addBook(b0); b.addBook(b5); b.addBook(b1); b.addBook(b3); b.addBook(b4); b.addBook(b2); 
		
		System.out.println("Sorting By ISBN number : ");
		b.sortByIsbnBooks();
		System.out.println();
		...
		//System.out.println();
		System.out.println("The writers who are aged between 50-55 : ");		
		c.getAuthAge();
		System.out.println();
		System.out.println("The Cheapest Book : ");
		c.getCheapestBook();
		System.out.println();
		System.out.println("The book with the highest book discount is : ");
		c.getHighestDiscountBook();
		System.out.println();
		System.out.println("Crime sub Genre book published after 2010 : ");
		c.getCrimeSubGBook();
		System.out.println();
